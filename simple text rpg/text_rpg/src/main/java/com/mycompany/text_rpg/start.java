...
public class start extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SAVE THE PRINCESS");

        startBtn.setBackground(new java.awt.Color(102, 255, 255));
        startBtn.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        startBtn.setText("START");
        startBtn.setBorder(null);
        startBtn.setDoubleBuffered(true);
    ...
    private void startBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startBtnActionPerformed
        firstStory fStory = new firstStory();
        fStory.setVisible(true);
